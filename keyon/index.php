    ...
    <div class="wrapper">
        ...
        <div class="gridarea">
            <div class="container">
                    ...
                    <!--<div class=provboxwrapper">
                        <div class="container">
                            <div class="mboxtitle"><h2>Provider Results</div>
                                <div class="msgbox col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="provlistcol1 col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                        <img src="https://www.caricaturemaster.com/assets/images/doctor-caricature/doctor-caricature-22.jpg" width="90" height="90" alt="Provider Images"/>
                                    </div>
                                    <div class="provlistcol2 col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
                                        <p>Dr Tommy Fraizer</p>
                                        <p>IU Physicians, Specialize in Pharmacy and Family Medicine</p>
                                    </div>
                                </div> 
                        </div>

                    </div>-->
                    <!--end Provider Search Result Section-->
            </div>
        </div>
    </div>
</body>
